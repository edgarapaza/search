    ...
    <div class="row">
      <div class="col-md-12">
        <header>
          ...
          <nav>
            <ul>
              <li><a href="lista.php"><span class="icon-home"></span>Buscar por Nombre</a></li>
              <li><a href="buscar_otor_juri.php"><span class="icon-suitcase"></span>Buscar datos Juridicos</a></li>
              <li class="submenu">
                <a href="buscar_x_fecha.php"><span class="icon-rocket"></span>Buscar por Fecha<span class=""></span></a>
                <ul class="children">
