...
?>
     ...
     */
        ...
        {
            $sqlEscritura1 = "SELECT num_sct, fec_doc, cod_sub, proy_id FROM escrituras1 WHERE cod_sct = ".$fila1["cod_sct"];
        ...
        <tbody>
            <tr>
                ...
                <td><a href="lista_detallada_juridica.php?codigo_escritura=<?php printf("%s",$fila1["cod_sct"]);?>&proyecto=<?php printf("%s",$row1["proy_id"]);?>">Mostrar Informacion</a></td>
        ...
        *                                   INICIO DE ZONA DE FAVORECIDOS
        ...
        {
            $i=1;
            $sqlEscritura2 = "SELECT num_sct, fec_doc, cod_sub, proy_id FROM escrituras1 WHERE cod_sct = ".$fila2["cod_sct"];
        ...
        <tbody>
            <tr>
                ...
                <td><a href="lista_detallada_juridica.php?codigo_escritura=<?php printf("%s",$fila2["cod_sct"]);?>&proyecto=<?php printf("%s",$row2["proy_id"]);?>">Mostrar Informacion</a></td>
            </tr>
